...
if __name__ == "__main__":
    ...
    parser.add_argument('--param', nargs='*', default=[1, .9, .07], type=float, help='parameter of Fed-IT loss')
    parser.add_argument('--eps', default=.3, type=float, help='centroid label smoothing factor')
    parser.add_argument('--use_fed_it', action='store_true', default=False, help='apply Fed-IT as loss function in training')
